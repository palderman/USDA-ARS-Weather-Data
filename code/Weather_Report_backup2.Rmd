...
```{r wind_dir_tobs, eval=FALSE, include=FALSE}
...
```{r wind_dir_day, eval=FALSE, include=FALSE}
wind_dir <- wth_data %>% 
  select(wind_dir_day) %>% 
  unique()
```
...
```{r weather_state_tobs, eval=FALSE, include=FALSE}
...
```{r weather_state_day, eval=FALSE, include=FALSE}
>>>>>>> 84c840181af3b12a82465ba3201f3f6b1759fa42
bad_states <- wth_data %>% 
...
```{r temp_range, eval=FALSE, include=FALSE}
...
```{r precip_amount, eval=FALSE, include=FALSE}
precip <- wth_data %>% 
...
```{r precip_snowfall_in_inches, eval=FALSE, include=FALSE}
wth_data %>% 
  ggplot()+
...
```{r precip_snow_depth_tobs, eval=FALSE, include=FALSE}
